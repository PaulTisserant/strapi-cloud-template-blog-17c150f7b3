...
export interface ApiEtablissementEtablissement
  ...
  attributes: {
    ...
    nom_etablissement: Schema.Attribute.String & Schema.Attribute.Required;
    offre: Schema.Attribute.Component<'shared.offre', false>;
    ouverture: Schema.Attribute.Component<'shared.ouverture', false>;
